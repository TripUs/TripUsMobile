...
public class TourAreaStaySubDto implements TourAreaInterface {
	...
	private String roomcode, roomtitle, roomsize1, roomcount, roombasecount, roommaxcount, roomintro, roombathfacility,
			roombath, roomhometheater, roomaircondition, roomtv, roompc, roomcable, roominternet, roomrefrigerator,
			roomtoiletries, roomsofa, roomcook, roomTable, roomhairdryer, roomimg1, roomimg1alt, roomimg2, roomimg2alt,
	...
	public String[] getTags() {
		String[] tags = { "roomcode", "roomtitle", "roomsize1", "roomcount", "roombasecount", "roommaxcount",
				"roomintro", "roombathfacility", "roombath", "roomhometheater", "roomaircondition", "roomtv", "roompc",
				"roomcable", "roominternet", "roomrefrigerator", "roomtoiletries", "roomsofa", "roomcook", "roomTable",
				"roomhairdryer", "roomimg1", "roomimg1alt", "roomimg2", "roomimg2alt", "roomimg3", "roomimg3alt",
	...
	public void setTagValue(String[] tags) {
		...
		this.roomhairdryer = tags[20];				this.roomimg1 = tags[21];
		this.roomimg1alt = tags[22];				this.roomimg2 = tags[23];
		this.roomimg2alt = tags[24];				this.roomimg3 = tags[25];
		this.roomimg3alt = tags[26];				this.roomimg4 = tags[27];
		this.roomimg4alt = tags[28];				this.roomimg5 = tags[29];
		this.roomimg5alt = tags[30];				
	}
